window.__ModuleLoader__.load({ id: "@x1a0f3n9/dshmarket", factory: (require) => {
		...
		* standing in it."
		*/
		const MARKET_PACKAGE_NAMES = [
			"@x1a0f3n9/dshmarket",
			"dshmarket",
			"dsh-market"
		];
		function marketSelfInstallName(installed) {
			for (const name of MARKET_PACKAGE_NAMES) if (installed[name] !== void 0) return name;
			return "@x1a0f3n9/dshmarket";
		}
		function isMarketItself(plugin) {
			return plugin.name === "dsh-market" || plugin.npm === "dshmarket" || plugin.npm === "@x1a0f3n9/dshmarket";
		}
		/**
		...
		*/
		...
		const tagId = "@x1a0f3n9/dshmarket/Market.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@x1a0f3n9/dshmarket";
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
										...
										href: "https://github.com/LunFengChen/dsh-market",
										target: "_blank",
										rel: "noreferrer",
			...
			(0, react.useEffect)(() => {
				...
				(async () => {
					...
					try {
						...
						const ownName = MARKET_PACKAGE_NAMES.find((name) => body.updates?.[name] !== void 0);
						const own = ownName === void 0 ? void 0 : body.updates?.[ownName];
